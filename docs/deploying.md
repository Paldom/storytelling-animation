...
- Consumers run `npx skills add Paldom/storytelling-animation` — the CLI
  ...
  users can also `gh skill install Paldom/storytelling-animation <skill>
...
gh repo edit Paldom/storytelling-animation --visibility public --accept-visibility-change-consequences
...
gh api repos/Paldom/storytelling-animation/private-vulnerability-reporting --method PUT
gh repo edit Paldom/storytelling-animation --enable-secret-scanning
gh repo edit Paldom/storytelling-animation --enable-secret-scanning-push-protection

# 3. Cut a versioned release (matches .claude-plugin/plugin.json) + topics
gh skill publish --tag v0.1.0
gh repo edit Paldom/storytelling-animation --add-topic skills-sh
#    (gh < 2.90 has no `gh skill`; equivalent fallback:
#     gh release create v0.1.0 --generate-notes
#     gh repo edit Paldom/storytelling-animation --add-topic agent-skills --add-topic skills-sh)
...
npx skills@latest add Paldom/storytelling-animation --list
mkdir -p /tmp/skills-verify && cd /tmp/skills-verify
env -u DISABLE_TELEMETRY -u DO_NOT_TRACK npx skills@latest add Paldom/storytelling-animation -a claude-code -y   # NO --skill '*': the wildcard opts into internal dev skills
...
curl -sIL https://skills.sh/Paldom/storytelling-animation | head -1
```
...
(`https://skills.sh/b/Paldom/storytelling-animation`) linking to the repo's
